        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.header}>
                    ...
                    <Text style={styles.titleHeader}>Danh Sách Sinh Viên</Text>
                    ...
                    <FlatList
                        ...
                        renderItem={({item}) => (
                            <View style={styles.content} >
                                ...
                                <TouchableOpacity style={styles.viewText} onPress={() => navigate("InforStudent2", {item: item})}>
                                ...
                                <View style={styles.viewBottom}>
                                    <Icon4 style={styles.iconEdit} name="edit" size={px2dp(23)}
                                           onPress={() => navigate("EditStudent",
                                               {
                                                   masv: item.masv,
