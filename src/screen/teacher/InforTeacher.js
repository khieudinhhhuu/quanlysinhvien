...
export default class InforTeacher extends Component {
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.header}>
                    ...
                    <Text style={styles.titleHeader}>Thông Tin Giảng Viên</Text>
                ...
                <View style={styles.body}>
                    ...
                    <View style={styles.content}>
                        <Text style={styles.textTensv}>Tên giảng viên: {this.state.currentUser.displayName}</Text>
                        <Text style={styles.textEmail}>Email: {this.state.currentUser.email}</Text>
                        <Text style={styles.textNganh}>Số điện thoại: {this.state.currentUser.phoneNumber}</Text>
